...
/**
 * @property C_MVC_Controller|C_Display_Type_Controller|A_NextGen_Pro_ImageBrowser_Controller|Mixin_NextGen_Basic_Templates $object
...
class A_NextGen_Pro_ImageBrowser_Controller extends Mixin
{
    ...
    function render_image_browser($displayed_gallery, $picture_list)
    {
        ...
        if (!empty($display_settings['template']) && $display_settings['template'] != 'default') {
            ...
            return $this->object->render_partial(NGG_PRO_IMAGEBROWSER . '#nextgen_pro_imagebrowser', $params, TRUE);
        }
    }
    /**
     * @param C_Displayed_Gallery $displayed_gallery
    ...
    function enqueue_frontend_resources($displayed_gallery)
    {
        ...
        wp_enqueue_style('nextgen_pro_imagebrowser_style', $this->object->get_static_url(NGG_PRO_IMAGEBROWSER . '#style.css'), array(), NGG_SCRIPT_VERSION);
        wp_enqueue_script('nextgen_pro_imagebrowser_script', $this->object->get_static_url(NGG_PRO_IMAGEBROWSER . '#imagebrowser.js'), array('ngg_common'), FALSE, TRUE);
